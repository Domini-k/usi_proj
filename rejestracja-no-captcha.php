...
<body>
    <div class="sectionsWrap">
        ...
        if (isset($_POST['login']) && $akcja == "Sign up!") {
        ...
        <form action="" method="post" class="formReje recaptchaForm">
            ...
            <input class="textInput" type="password" name="haslo" size=30 maxsize=3 placeholder="Password" required />
            <input type="submit" name="akcja" value="Sign up!" class="buttonReje" id="submitButton" />
            <input type="submit" name="akcja" value="Delete" class="buttonReje" id="submitButton" />
